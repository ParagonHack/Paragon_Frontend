    ...
    <nav className="px-10">
      ...
      <div className="navbar">
        ...
        <div className="flex items-center" style={{ marginTop: '20px' }}>
          <Link href="/signin">
            <span className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-gray-50">New Chat</span>
          </Link>
        </div>
        ...
        <div className="navbar-bottom">
          ...
          <div className="flex items-center">
            <Link href="/helpPage">
              <span className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-gray-50">Help</span>
            </Link>
          </div>
